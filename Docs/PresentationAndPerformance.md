...
- Exposed upper boxes use one cached three-submesh tray surface: a color-matched face, nine shallow
  cup walls, and nine darker cup interiors. Covered boxes keep a clean closed face until they
  become selectable, matching the reference game's interaction language.
